UTILS 				= utils/ft_putnbr.c utils/ft_putstr.c utils/ft_split.c \
	...
	utils/ft_put_job_in_foreground.c utils/ft_put_job_in_background.c \
	utils/ft_format_job_info.c utils/ft_wait_for_job.c \
	utils/ft_job_is_stopped.c utils/ft_job_is_completed.c \
	utils/ft_do_job_notification.c utils/ft_mark_job_as_running.c \
	utils/ft_continue_job.c utils/ft_putstr_fd.c utils/ft_free_job.c \
	utils/ft_mark_process_status.c utils/ft_itoa.c utils/ft_calloc.c \
	utils/ft_bzero.c
...
SRCS_WITHOUT_MAIN	=  srcs/ft_exit_minishell.c srcs/clearScreen.c \
	...
	srcs/ft_init_minishell.c ${UTILS}
